...
$statement = $db->prepare(' select sensorDeployedId, dataCollectedDate, firedHours from sensorTimeSeries where sensorDeployedId = ?'); // Warning: This returns *many* rows without the LIMIT!
