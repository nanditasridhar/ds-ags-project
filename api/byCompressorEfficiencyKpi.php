...
$statement = $db->prepare(' select sensorDeployedId, dataCollectedDate, compressorEfficiency from sensorTimeSeries where sensorDeployedId = ?'); // Warning: This returns *many* rows without the LIMIT!
