...
$statement = $db->prepare(' select sensorDeployedId, dataCollectedDate, availability from sensorTimeSeries where sensorDeployedId = ?'); // Warning: This returns *many* rows without the LIMIT!
