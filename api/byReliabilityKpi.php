...
$statement = $db->prepare(' select sensorDeployedId, dataCollectedDate, reliability from sensorTimeSeries where sensorDeployedId = ?'); // Warning: This returns *many* rows without the LIMIT!
